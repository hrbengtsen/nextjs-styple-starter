import { Container, Flex, Heading, Code, Tooltip } from "@styple/design-system";
...
export default function Home() {
  return (
    <Container>
      ...
      >
        <Heading css={{ fontWeight: "$black", fontSize: "$3xl" }}>
          Welcome to <Link href="https://nextjs.org">Next.js</Link> +{" "}
          <Link href="https://www.styple.dev/">styple</Link>
        </Heading>
        ...
        <Flex css={{ gap: "$sm" }}>
          <Tooltip
            content={
              <>
                Visit <b>Next.js</b> documentation
              </>
            }
          >
            <NavLinkItem
          ...
          <Tooltip
            content={
              <>
                Visit <b>styple</b> documentation
              </>
            }
          >
            <NavLinkItem
              href="https://www.styple.dev/docs"
              size="circle"
              highlight
              move
            >
